...
controlvars={'srmethod','inputfilename','readinputfile','readevap','readstagedischarge','pullstationdata','pullreleaserecs','runriverloop','runwcloop','doexchanges','runcaptureloop','runcalibloop'};
...
if readstagedischarge==1
    SDmat=readmatrix([basedir inputfilename],'Sheet','stagedischargenew');
    ...
    save([basedir 'StateTL_SRdatastagedis.mat'],'stagedischarge');
else
...
% clear ans CALx
% save('C:\Projects\Ark\ColorsofWater\matlab\CAL_Div2.mat')
...
save([basedir 'StateTL_Qnode.mat'],'Stations');
    ...
    if readinputfile==1  %if reload SR data need to reattach gage data...
        for wd=SR.(ds).WD
            wds=['WD' num2str(wd)];
            for r=SR.(ds).(wds).R
                rs=['R' num2str(r)];
